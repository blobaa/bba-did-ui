            ...
            <Layout>
                ...
                <Row>
                    ...
                    <div style={{ color: "#666", fontSize: "large" }}>
                        ...
                        <p>
                            The website is a statically generated <a href="https://en.wikipedia.org/wiki/Single-page_application">SPA</a> and runs entirely in your browser. This means that no private keys and passphrases are sent to any server and that transaction signing and key generation is done locally in your browser. The source code is available <a href="https://github.com/blobaa/bba-did-ui">here</a>.
                        </p>
                        <div style={{ paddingTop: "1rem" }}/>
                        <p>
